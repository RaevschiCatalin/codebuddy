            ...
            <div className="space-y-4 xl:space-y-6">
                ...
                <div className="space-y-2">
                    <div className="flex justify-center items-center flex-col space-y-3 text-lg font-medium leading-6">
                        ...
                        <div className="flex justify-center mt-5 space-x-5"><a href="#" target="_blank"
                            ...
                            <svg
                               ...
                               className="inline-block text-gray-400"><span className="sr-only">GitHub</span>
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer"
                               className="inline-block text-gray-400"><span className="sr-only">Linkedin</span>
                                <svg
